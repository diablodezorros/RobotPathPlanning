...
def go(bug,grid):
   bug.doBug2(grid)
   print 'the final path is:', bug.bug2Path
   print 'the direct path is:', bug.path
   print 'the final path: ', grid.printPath(bug.bug2Path)
   print 'compare to the direct path', grid.printPath(bug.path)
